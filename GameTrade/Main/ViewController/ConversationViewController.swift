...
extension ConversationViewController: MessageImageDelegate {
...
extension ConversationViewController: CCPChannelDelegate {
...
extension ConversationViewController: CCPConnectionDelegate {
    ...
    func handleAudioMessageAction(audioButton: InputBarButtonItem) {
        ...
        do {
            if #available(iOS 10.0, *) {
                ...
                try! recordingSession.setCategory(AVAudioSessionCategoryPlayAndRecord, mode: AVAudioSessionModeDefault, options: [])
...
extension ConversationViewController: MessagesDataSource {
    ...
    public func cellBottomLabelAlignment(for message: MessageType, at indexPath: IndexPath, in messagesCollectionView: MessagesCollectionView) -> LabelAlignment {
        ...
        return dataSource.isFromCurrentSender(message: message as! MessageType) ? .messageTrailing(UIEdgeInsets(top: 0, left: 0, bottom: 0, right: 15)) : .messageLeading(.zero)
    }
}
