...
//        self.view.endEditing(true)
    ...
    @IBAction func fetchCode(_ sender: UIButton) {
        ...
        self.vm.sendMobileCode(mobile: userTextField.text!, method: "register", validateCode: imageTextField.text!) { (_, msg, isSuc) in
...
extension RegisterViewController: UITextFieldDelegate,JXKeyboardTextFieldDelegate {
